function changeVolumeList(subjectData) {
  ...
  function fullArrayAsClass(fullArray){
    classArray = []
    for (i=0; i<fullArray.length; i++){
      classArray.push({id: fullArray[i][0], session: fullArray[i][1]})
    }
    return classArray
  }
  
  //////needs to be through the tsv rather than the array. can also be in a different file
